      ...
      <el-card class="box-card">
        ...
        <div style="margin-bottom:50px;">
          <el-col :span="4" class="text-center">
            <el-button class="pan-btn blue-btn">Components</el-button>
          </el-col>
          <el-col :span="4" class="text-center">
            <el-button class="pan-btn light-blue-btn">Charts</el-button>
          </el-col>
          <el-col :span="4" class="text-center">
            <el-button class="pan-btn pink-btn">Excel</el-button>
          </el-col>
          <el-col :span="4" class="text-center">
            <el-button class="pan-btn green-btn">Table</el-button>
          </el-col>
          <el-col :span="4" class="text-center">
            <el-button class="pan-btn tiffany-btn">Form</el-button>
          </el-col>
          <el-col :span="4" class="text-center">
    ...
    <el-row :gutter="20" style="margin-top:50px;">
      ...
      <el-col :span="6">
        <el-card class="box-card">
          ...
          <div class="component-item">
            <mallki className="mallki-text" text="admin"></mallki>
          </div>
        </el-card>
      </el-col>
    </el-row>
